...
# We use the min() and max() methods to get the minimum and maximum values of the list we then save,
...
#Of course, this wouldn't give him any profit at all if he was simply to buy and sell it at the same price. Instead, 
